# FUI-AS Per-Type Reference (v2)

Use this page for per-type member-level pages after finding the surface in [SDK docs index](../SDK_INDEX.md).

All controls and nodes listed below inherit common `Node` state APIs, including `enabled(...)` and `visibility(...)` (`Normal`, `Hidden`, `Collapsed`).

## Controls

- [AntiSelectionArea](./controls/AntiSelectionArea.md)
...
- [ScrollBar](./nodes/ScrollBar.md)
- [ScrollBox](./nodes/ScrollBox.md)
- [ScrollState](./nodes/ScrollState.md)
